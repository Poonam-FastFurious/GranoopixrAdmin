...
import { Blocks, ChevronRight, Grid2x2, ListCheck,  } from "lucide-react";
...
function Aside({ sideMenu, setSideMenu }) {
  ...
  const menuItems = [
    { id: 0, label: "Dashboard", icon: <Grid2x2 size={18} />, link: "/" },
    {
      ...
      subMenu: [{ label: "Banner List", link: "/Banner" }],
    },
  ];
  return (
    <>
      <div className="tp-main-wrapper bg-slate-100 ">
        ...
        >
          <div className="py-4 pb-8 px-8 border-b border-gray h-[78px]  bg-gray-800">
            <Link to="/">
              <img
                className="w-[140px]  "
                src={
                  "https://granoopixr.com/assets/LOGO%20(4)-Btv5xxaQ.png"
                }
                alt="Logo"
              />
            </Link>
